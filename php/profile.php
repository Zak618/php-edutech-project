...
if ($result->num_rows > 0) {
    ...
    $profile_image = './database/avatars/' . $row['image'];
}

// Проверка существования файла аватара
if (!file_exists($profile_image)) {
    echo "Аватар не найден: $profile_image";
    $profile_image = "";
}
...
<div class="p-2 text-white bg-opacity-75" style="height: 400px; background-image: url('<?php echo "../image/profile/3.jpg"; ?>');">
    <div class="text-center">
        <img src="<?php echo !empty($profile_image) ? $profile_image : $default_image; ?>" class="rounded-circle" width="18%" style="margin-top: 260px">
    </div>
</div>
